...
namespace Mashlan.DynamicJson.Api.Configuration.Startup.Logging
{
    /// <summary>
        ...
        public static void Configure(IApplicationBuilder app)
        {
            app.Use(async (context, next) =>
            {
                ...
                try
                {
                    ...
                    //log results
                    Log.Write(level, (string) MessageTemplate, method, path, statusCode, stopwatch.Elapsed.Milliseconds);
                }
