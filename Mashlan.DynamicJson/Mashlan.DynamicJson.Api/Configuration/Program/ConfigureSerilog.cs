...
namespace Mashlan.DynamicJson.Api.Configuration.Program
{
    /// <summary>
    ...
    public class ConfigureSerilog
    {
        ...
        /// <exception cref="System.ArgumentNullException"><paramref name="hostingEnvironment"/> is <see langword="null"/></exception>
        /// <exception cref="System.ArgumentException">Condition.</exception>
                                  ...
                                  string applicationName)
        {
            ...
            var logDirectory = hostingEnvironment.IsEnvironment(EnvironmentTypes.Local)
                ? $"log/ler-{applicationName}.log" //local debug (windows)
                : $"/var/log/app/ler-{applicationName}.log"; // Docker path to be picked up by Splunk (linux)
